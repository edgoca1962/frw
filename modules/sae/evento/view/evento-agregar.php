...
/**
 * 
 * Plantilla para mantenimiento de eventos
 * 
 * @package: WPFRW
 * Semilla: 9.951567907287947, -84.19050302413895
 */
...
<?php if ($core->get_atributo('post_abc') === 'todos' || $core->get_atributo('post_abc') === 'propios') : ?>
   <form id="evento" enctype="multipart/form-data" class="row g-3 needs-validation mb-5" novalidate style="overflow:hidden;">
      <section class="border border-2 rounded px-5 py-3">
         <div class="row mb-3">
            <div class="col">
               <input id="title" name="title" type="text" class="form-control" placeholder="Título del Evento" value="" required>
         ...
         <div class="row row-cols-1 row-cols-md-2">
            <div class="col-xl-8 mb-3">
               <textarea class="form-control w-100" rows="8" name="content" id="content" placeholder="Descripción del Evento"></textarea>
            </div> <!-- descripción del evento -->
            <div class="col-xl-4 mb-3">
               <div class="card text-bg-dark shadow">
                  <img id="imagennueva" src="<?php echo WPFRW_DIR_URI . '/assets/img/sae/eventobg.jpeg' ?>" class="card-img" style="width: 100%; height: 200px; object-fit: cover;" alt="Imágen del evento">
         ...
         <div class="row row-cols-1 row-cols-md-2 row-cols-xl-4 mb-3 d-flex align-items-center">
            ...
            <div class="col">
               <div class="form-check form-switch mt-4">
                  <input class="form-check-input" type="checkbox" role="switch" id="inscripcion" name="inscripcion" value="off">
            ...
            <div class="col">
               <div class="form-check form-switch d-flex my-2">
                  <input class="form-check-input" type="checkbox" role="switch" id="donativo" name="donativo" value="off">
            ...
            <div class="col">
               <div class="form-check form-switch d-flex my-2">
                  <input class="form-check-input" type="checkbox" role="switch" id="aforo" name="aforo" value="off">
         ...
         <div class="row row-cols-1 row-cols-md-2 row-cols-xl-5 mb-3 d-flex align-items-center">
            ...
            <div class="col-auto mb-3">
               ...
               <input type="time" class="form-control" id="h_inicio" name="h_inicio" value="<?php echo date('H:00', strtotime('+2 hours')) ?>" step="900">
               <div class="invalid-feedback">
            ...
            <div class="col-auto mb-3">
               ...
               <input type="time" class="form-control" id="h_final" name="h_final" value="<?php echo date('H:00', strtotime('+3 hours')); ?>" step="900">
               <div class="invalid-feedback">
                  Seleccionar hora exacta o facción de 15 min.
               </div>
            </div> <!-- h_final -->
            <div class="col-auto">
               <div id="diacompleto" class="form-check form-switch mt-xl-3">
                  <input class="form-check-input" type="checkbox" role="switch" id="dia_completo" name="dia_completo" value="off">
         ...
         <div class="row mb-3 align-items-center">
            <div class="col-auto pb-md-3">
               <div class="form-check form-switch mt-md-3">
                  <input class="form-check-input" type="checkbox" role="switch" id="evento_virtual" name="evento_virtual" value="off">
                  <label class="form-check-label" for="evento_virtual">Evento virtual</label>
               </div>
            </div> <!-- Encendido -->
            <div class="col-md-6">
               <input class="form-control" type="text" id="enlace_virtual" name="enlace_vitual" placeholder="Enlace del evento virtual" disabled hidden>
            </div> <!-- Enlace -->
            <div id="direccion">
               <div class="col-md-6 mb-3">
                  <input id="d_name" name="d_name" class="form-control" type="text" placeholder="Nombre del lugar..." value="Catedral Metropolitana">
               </div>
               <div class="d-flex justify-content-between" id="search-container">
                  <div class="row w-100">
                     ...
                     <div class="col-3 pe-1">
                        <input id="lat" class="form-control" type="numeric" placeholder="Latitud">
                     </div>
                     <div class="col-3 px-0">
                        <input id="lon" class="form-control" type="numeric" placeholder="Longitud">
                     </div>
                     <div class="col-2">
               ...
               <input type="hidden" id="latitud" name="latitud" value="9.934020789178819">
               <input type="hidden" id="longitud" name="longitud" value="-84.07908901340035">
               <div class="row">
                  <div class="col">
